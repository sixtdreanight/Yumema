...
[Releases](https://github.com/dreamnight16/ai-companion/releases) から対応プラットフォームのインストールパッケージをダウンロードしてください：
...
- [companion-engine](https://github.com/dreamnight16/companion-engine) — 本アプリケーションを動かすコアエンジン
